...
// Em ambiente de teste (Jest), não arrancar o servidor automaticamente
// Jest importa este módulo directamente — connectDB mock deve estar antes do require()
if (process.env.NODE_ENV !== 'test') {
  start();
}

module.exports = app; // para testes Jest (supertest usa app directamente)
